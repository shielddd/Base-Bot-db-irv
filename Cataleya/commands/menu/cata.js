// le code est en anglias ( il avait un problème et un anglais ma aider )
        ...
        if (fs.existsSync(path2)) {
            ...
            fs.access(path, fs.F_OK, (err) => {
                if (err) {
                    ...
                    console.error(red('Fichier: ' + path + ' éxiste deja'))

                    const err = new Discord.MessageEmbed()
                        .setDescription(`Déjà dans la data.`)
                        .setColor(0x36393E)
